const long double inf = 1e100, eps = 1e-12, PI = acos(-1L);
struct point {
	long double x, y;
...
long double distancePointLine(point p, point a, point b) {
...
long double distancePointSegment(point p, point a, point b) {
